...
Linux Apps Manager is a shell script program that allows you to easily manage your Linux apps using different app managers such as APT, Snap and Flatpak.
...
2. Choose the option 4 to run setup.
