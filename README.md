...
Linux Apps Manager is a shell script program that allows you to easily manage your Linux apps using different app managers such as APT, Pacman, DNF, DEB, RPM, Snap and Flatpak.
...
2. Choose the option 9 to run setup.
